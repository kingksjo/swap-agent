...
export const LandingPage: React.FC<LandingPageProps> = ({ onSendMessage }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center">
      <div className="mb-4">
        <span className="inline-block bg-background-secondary text-text-secondary text-sm font-medium px-4 py-2 rounded-full">
          Introducing Miye
        </span>
      </div>
      ...
      <div className="absolute bottom-4 text-xs text-text-secondary/50">

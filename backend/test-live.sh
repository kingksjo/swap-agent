...
test_api "Missing API Key" "GET" "/api/connection-test" "" "401"
test_api "Invalid API Key" "GET" "/api/connection-test" "" "401"
test_api "StarkNet Connection" "GET" "/api/connection-test" "" "200"
test_api "Token List" "GET" "/api/tokens" "" "200"
test_api "Mock Quote" "GET" "/api/quote?fromToken=ETH&toToken=USDC&amount=0.1" "" "200"
test_api "Real AutoSwap Quote" "GET" "/api/quote-real?fromToken=ETH&toToken=USDC&amount=0.1" "" "200"
test_api "Invalid Quote Params" "GET" "/api/quote-real?fromToken=ETH" "" "400"
test_api "Same Token Quote" "GET" "/api/quote-real?fromToken=ETH&toToken=ETH&amount=0.1" "" "400"
test_api "Zero Amount Quote" "GET" "/api/quote-real?fromToken=ETH&toToken=USDC&amount=0" "" "400"
test_api "Mock Swap" "POST" "/api/swap" '{"fromToken":"ETH","toToken":"USDC","amount":"0.01"}' "200"
test_api "Real AutoSwap Swap" "POST" "/api/swap-real" '{"fromToken":"ETH","toToken":"USDC","amount":"0.01"}' "200"
test_api "Invalid Swap Data" "POST" "/api/swap-real" '{"fromToken":"ETH"}' "400"
